...
class Loupe(imageView: ImageView, container: ViewGroup) : View.OnTouchListener,
    ...
    var isViewTranslateAnimationRunning = false
    ...
    var isBitmapScaleAnimationRunninng = false
    ...
    private fun zoomOutToMinimumScale(isOverScaling: Boolean = false) {
        ...
        onScaleChangedListener?.onScaleChange(
            endScale,
            bitmapBounds.centerX(),
            bitmapBounds.centerY()
        )
